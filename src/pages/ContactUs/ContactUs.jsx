        ...
        <div className="bg-gradient-to-r from-primary-700 via-primary-600 to-violet-600 text-white py-16">
          <div className="container-custom text-center">
            ...
            <motion.p
              ...
              className="text-xl"
            >
              Got a question or need support? We'd love to hear from you.
            </motion.p>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <p className="text-slate-600 dark:text-slate-400 mb-8">
                Whether you need help with a loan application, have billing
                questions, or just want to learn more about our services — our
                friendly team is always happy to assist.
              </p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 dark:text-slate-400">
                      45 Greenway Avenue, Suite 12, Gulshan
                      <br />
