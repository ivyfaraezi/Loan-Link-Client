        ...
        >
          ...
          <ul className="space-y-3 text-slate-600 dark:text-slate-400">
            <li className="flex items-start gap-3">
              ...
              Design and publish tailored loan products with competitive
              interest rates
            </li>
            <li className="flex items-start gap-3">
              <span className="text-primary-600 mt-1">•</span>
              Evaluate borrower applications and make approval or rejection
              decisions
            </li>
            <li className="flex items-start gap-3">
              <span className="text-primary-600 mt-1">•</span>
              Track and verify application fee payments from borrowers
            </li>
            <li className="flex items-start gap-3">
              <span className="text-primary-600 mt-1">•</span>
              Provide timely updates and support to borrowers throughout the
              process
            </li>
          </ul>
        </motion.div>
