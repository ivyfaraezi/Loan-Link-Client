    ...
    <>
      ...
      <div className="max-w-4xl mx-auto space-y-6">
              ...
              <div className="flex flex-col md:flex-row md:items-end gap-4">
                <div className="relative">
                  <img
                    ...
                    className="w-24 h-24 md:w-32 md:h-32 rounded-xl border-4 border-white dark:border-slate-800 object-cover bg-white"
                  />
                  {editing && (
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        value={user?.email}
                        disabled
                        className="input-field pl-10 bg-slate-100 dark:bg-slate-700 cursor-not-allowed"
                      />
                    </div>
        ...
        <motion.div
          ...
          className="bg-gradient-to-r from-primary-50 to-violet-50 dark:from-primary-900/20 dark:to-violet-900/20 rounded-2xl p-6 border border-primary-100 dark:border-primary-800"
        >
          <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-4">
          ...
          <ul className="space-y-2 text-slate-600 dark:text-slate-400">
            <li className="flex items-start gap-2">
              ...
              Ensure your profile details and contact info are always current
            </li>
            <li className="flex items-start gap-2">
              <span className="text-primary-600 mt-1">✓</span>
              Submit accurate employment and income details with your
              application
            </li>
            <li className="flex items-start gap-2">
              <span className="text-primary-600 mt-1">✓</span>
              Complete application fee payment early to avoid processing delays
            </li>
            <li className="flex items-start gap-2">
              <span className="text-primary-600 mt-1">✓</span>
              Clearly describe the purpose and repayment plan for your loan
            </li>
          </ul>
        </motion.div>
      </div>
