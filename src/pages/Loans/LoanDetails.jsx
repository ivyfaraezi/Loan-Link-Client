...
const LoanDetails = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-slate-50 dark:bg-slate-950 py-4 sm:py-6 md:py-8">
        <div className="container-custom px-2 sm:px-4 md:px-0">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
            ...
            >
              {/* Loan Image */}
              <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 overflow-hidden mb-4 sm:mb-6">
                <img
                  src={
                    loan.image ||
              ...
              {/* Loan Details Card */}
              <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 p-4 sm:p-6 md:p-8">
                ...
                <p className="text-slate-600 dark:text-slate-400 text-base sm:text-lg mb-6 sm:mb-8 leading-relaxed break-words max-h-32 sm:max-h-40 md:max-h-60 overflow-auto">
                  {loan.description}
                </p>

                {/* Key Features */}
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
                  <div className="flex items-start gap-3 sm:gap-4 p-3 sm:p-4 bg-slate-50 dark:bg-slate-700 rounded-xl">
                  ...
                  <div className="flex items-start gap-3 sm:gap-4 p-3 sm:p-4 bg-slate-50 dark:bg-slate-700 rounded-xl">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500">loan limit</p>
                    </div>
                  </div>

                  <div className="flex items-start gap-3 sm:gap-4 p-3 sm:p-4 bg-slate-50 dark:bg-slate-700 rounded-xl">
                    <div className="p-3 bg-primary-100 dark:bg-primary-900 rounded-lg">
                      <FiCalendar className="text-xl text-primary-600 dark:text-primary-400" />
                    </div>
                    <div>
                      <p className="text-sm text-slate-500 dark:text-slate-400">
                        EMI Options
                  ...
                  <div className="flex items-start gap-4 p-4 bg-slate-50 dark:bg-slate-700 rounded-xl">
            ...
            >
              {/* Apply Card */}
              <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 p-4 sm:p-6 sticky top-24">
                <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-4">
                  Apply for this Loan
                </h3>

                <div className="space-y-3 sm:space-y-4 mb-4 sm:mb-6">
                  <div className="flex justify-between items-center py-2 sm:py-3 border-b border-slate-200 dark:border-slate-700">
                ...
                {/* Security Badge */}
                <div className="mt-4 sm:mt-6 p-3 sm:p-4 bg-slate-50 dark:bg-slate-700 rounded-xl">
              ...
              {/* Manager Info */}
              {loan.managerEmail && (
                <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 p-4 sm:p-6 mt-4 sm:mt-6">
