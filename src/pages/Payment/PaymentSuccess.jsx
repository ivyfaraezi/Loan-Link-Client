...
const PaymentSuccess = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-green-50 to-white dark:from-green-900/20 dark:to-slate-900 flex items-center justify-center p-4">
        <motion.div
        ...
        >
          ...
          <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div className="p-8">
              ...
              {/* Next Steps */}
              <div className="bg-primary-50 dark:bg-primary-900/20 rounded-2xl p-6 mb-6 border border-primary-100 dark:border-primary-800">
                <h3 className="font-bold text-primary-800 dark:text-primary-400 mb-3">
                  📋 What's Next?
                </h3>
